...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['shipping', 'billing']> &
      Schema.Attribute.Required &
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  options: {
    comment: 'Product categories from SBIS';
    draftAndPublish: false;
  };
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sbisId: Schema.Attribute.Integer & Schema.Attribute.Unique;
    sbisParentId: Schema.Attribute.Integer;
...
export interface ApiFavoriteFavorite extends Struct.CollectionTypeSchema {
  ...
  options: {
    comment: 'User favorite products';
    draftAndPublish: false;
  };
  attributes: {
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cdekDeliveryTimeMin: Schema.Attribute.String;
    cdekOrderUuid: Schema.Attribute.String & Schema.Attribute.Unique;
    cdekPvzAddress: Schema.Attribute.Text;
    cdekPvzCode: Schema.Attribute.String;
    cdekStatus: Schema.Attribute.String;
    cdekTariffCode: Schema.Attribute.Integer;
    cdekTrackNumber: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customerData: Schema.Attribute.JSON;
    deliveryType: Schema.Attribute.Enumeration<['door', 'pvz', 'pickup']> &
      Schema.Attribute.DefaultTo<'door'>;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order: Schema.Attribute.Relation<'manyToOne', 'api::order.order'> &
      Schema.Attribute.Required;
    paymentData: Schema.Attribute.JSON;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    rootCategoryName: Schema.Attribute.String;
    sbisExternalId: Schema.Attribute.String;
    sbisId: Schema.Attribute.Integer & Schema.Attribute.Unique;
    sbisLastSoldAt: Schema.Attribute.DateTime;
    sbisNomNumber: Schema.Attribute.String;
    sbisPopularityScore: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    sbisSalesCount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    sbisStatsLastUpdated: Schema.Attribute.DateTime;
    sbisTotalQuantitySold: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    sbisTotalRevenue: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
